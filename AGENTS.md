...
- `public/assets/content/bbs/welcome.ans`, `menu.ans`, `about.ans`, and `doors.ans` are static ANSI BBS screens.
...
- `public/assets/Adam Burmister - Full Stack Engineer - Resume.pdf` is the downloadable resume served by the BBS CV option.
